...
class Kama_Breadcrumbs
{
   ...
   static $l10n = [
      ...
      'year'       => 'Yearly archive: <b>%d</b>',
      'month'      => 'Monthly archive: <b>%s</b>',
      'day'        => '',
      'attachment' => 'Media: %s',
   ...
   static $args = [
      ...
      'title_patt'      => '<span class="kb_title breadcrumb-item text-primary active">%s</span>',
      ...
      if (1) {
         ...
         elseif ($mark === 'schema.org') {
            $mark = [
               ...
               'linkpatt'  => '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="breadcrumb-item"><a href="%s" itemprop="item" class="text-white"><span itemprop="name">%s</span></a></span>',
               'sep_after' => '',
            ];
